"""
Model 4 -- PLACEHOLDER, not implemented yet.

This file only exists to define the calling contract every model in this
platform is expected to follow, so that when the real Model 4 logic is
...
MODEL_NAME = "Model 4 (not yet implemented)"


def recommend(skills: List[str], interests: List[str], **kwargs) -> List[Dict[str, Any]]:
    raise NotImplementedError(
        "Model 4 has not been built yet. Implement recommend(skills, interests, **kwargs) "
